 ...
 */
final class Version20231029155406 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recipe_allergen_type (recipe_id INT NOT NULL, allergen_type_id INT NOT NULL, INDEX IDX_F46E266B59D8A214 (recipe_id), INDEX IDX_F46E266BF7A7758 (allergen_type_id), PRIMARY KEY(recipe_id, allergen_type_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE recipe_score (recipe_id INT NOT NULL, score_id INT NOT NULL, INDEX IDX_248AE34E12EB0A51 (score_id), INDEX IDX_248AE34E59D8A214 (recipe_id), PRIMARY KEY(recipe_id, score_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
